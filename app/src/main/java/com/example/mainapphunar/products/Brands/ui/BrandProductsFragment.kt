package com.example.mainapphunar.products.Brands.ui
...
import com.example.mainapphunar.products.Brands.ViewModel.BrandViewModel

class BrandProductsFragment : Fragment(R.layout.fragment_brand_products) {
    private val mainAppLivedata: BrandViewModel by viewModels()
